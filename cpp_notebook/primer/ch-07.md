...
public:
	...
	Sales_data(std::string id, unsigned new_sold, double price):
		...
		// i can specify commands to do a backflip
	}
	
	// default constructor as a delegating constructor
	// this unnecessarily overrides the in-class initializers below, but this is just an example.
	Sales_data(): 
		Sales_data("", 0, 0) { 
		// initializes members according to constructor A
		// automatically does a backflip as specified in constructor A
		
		// i can specify further commands to do something after backflip, like do a pushup
	}
	...
	Sales _data(std::string id): 
		...
		// initializes members according to constructor A
		// automatically does a backflip as specified in constructor A
		// i can specify further commands to do something after backflip, like take a shot
	}
