...
- **implicit class-type conversions (*bad!*)**
	...
	- **bottom line (at least for now as a beginner): do not allow implicit class-type conversions!!** (except for [copy control](https://github.com/tedklin/pseudoblog/blob/master/cpp_notebook/primer/ch-13.md))
