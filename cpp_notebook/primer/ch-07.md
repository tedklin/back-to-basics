...
public:
	...
	Sales_data(unsigned new_sold, double price):
...
public:
	...
	Sales_data(std::string id, unsigned new_sold, double price):
		units_sold_(new_sold), revenue_(price*new_sold), id_(id) {
		// specify commands to do a backflip
	}
	
	// default constructor as a delegating constructor
	// keep in mind this overrides the in-class initializers below, 
	// which is unnecessary in this case and usually bad practice!
	Sales_data(): 
		Sales_data("", 0, 0) { // automatically does a backflip
		// specify commands to do something after backflip
	}
	
	// other constructor as a delegating constructor
	Sales _data(std::string id): 
		Sales_data(id, 0, 0) { // automatically does a backflip
		// specify commands to do something after backflip
	}
