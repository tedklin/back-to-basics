...
- **default constructor**
	- the default constructor of a class controls [default initialization *and* value initialization](https://github.com/tedklin/pseudoblog/blob/master/cpp_notebook/primer/ch-02.md#variables-22) on objects of the class-type.
		- **when <ins>using</ins> a class, don't confuse an object declaration with a function declaration!**
...
public:
	...
	Sales_data(std::string id, unsigned new_sold, double price):
		...
		// this specific constructor can specify commands to do a backflip
	}
	...
	Sales_data(): 
		...
		// this specific constructor specify further commands like do a pushup
	}
