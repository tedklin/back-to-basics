...
- initialization
	...
	- ***default initialization***
		...
		- [classes control how objects of that class type are default initialized (and value initialized).](https://github.com/tedklin/pseudoblog/blob/master/cpp_notebook/primer/ch-07.md#constructors)
			- **classes without a default constructor don't allow default initialization (or value initialization) at all**, but most classes have default constructors that let us safely define objects without explicit initializers.
	...
	- ***value initialization***
		...
		- happens when:
			...
			- we only supply a size to something like a vector to be initialized.
		-  the library implicitly creates a value-initialized element initializer for each element:
			- **zero for built-in types**, **using the default constructor for class types**
