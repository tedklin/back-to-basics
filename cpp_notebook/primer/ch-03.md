...
- vector initialization
	...
	- direct initialize from a specified number of elements with each element value initialized.
...
- pointers and arrays
	- **the compiler automatically converts the name of an array with a pointer to its first element in most expressions.**
