...
- declaration and definition of functions in / related to a class:
	...
	- functions defined in the class are automatically [*inline*](https://github.com/tedklin/pseudoblog/blob/master/cpp/primer/ch-06.md#other-features-65).
...
- **default constructor**
	- the default constructor of a class controls [default initialization *and* value initialization](https://github.com/tedklin/pseudoblog/blob/master/cpp/primer/ch-02.md#variables-22) on objects of the class-type.
...
### new core ideas
- **type members** (local [type aliases](https://github.com/tedklin/pseudoblog/blob/master/cpp/primer/ch-02.md#dealing-with-types-25)) can be defined by a class.
...
- **implicit class-type conversions (*bad!*)**
	...
	- **bottom line (at least for now as a beginner): do not allow implicit class-type conversions!!** (except for [copy control](https://github.com/tedklin/pseudoblog/blob/master/cpp/primer/ch-13.md))
		- **declare <ins>single-argument</ins> constructors with the prefix keyword *explicit* to suppress implicit conversions.**
			- side-effects: explicit constructors can only be used with [direct initialization (not copy initialization with an = sign)](https://github.com/tedklin/pseudoblog/blob/master/cpp/primer/ch-02.md#variables-22), and the compiler will not use this constructor in an automatic conversion (users will have to [explicitly cast](https://github.com/tedklin/pseudoblog/blob/master/cpp/primer/ch-04.md#type-conversions) it to convert it).
...
- recall [forms of initialization](https://github.com/tedklin/pseudoblog/blob/master/cpp/primer/ch-02.md#variables-22) (use direct!)
